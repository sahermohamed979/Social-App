...
export default function Profile() {
  ...
  const date = new Date(LogData?.data?.data?.data.user?.createdAt);
  const now = new Date();
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <span>
                    ...
                    <span className="font-semibold text-gray-900">
                      {LogData?.data?.data?.data.user?.email
                        ?.charAt(0)
                        .toUpperCase() +
                        LogData?.data?.data?.data.user?.email?.slice(1)}
                    </span>
                  </span>
                </div>
                ...
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <span>
                    Date of Birth{" "}
                    <span className="font-semibold text-gray-900">
                      {LogData?.data?.data?.data.user?.dateOfBirth
                        ? new Date(
                            LogData.data.data.data.user.dateOfBirth,
                ...
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <span className="font-semibold text-gray-900">
                    {LogData?.data?.data?.data.user?.gender
                      ?.charAt(0)
                      .toUpperCase() +
                      LogData?.data?.data?.data.user?.gender?.slice(1)}
                  </span>
                </div>
                <div className="flex items-center gap-3 text-gray-600">
